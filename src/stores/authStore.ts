...
function mergeWithSavedProfile(profile: UserProfile | null): UserProfile | null {
  ...
  return {
    ...
    has_disability: saved.has_disability ?? profile.has_disability,
    education_level: saved.education_level ?? profile.education_level,
    current_course: saved.current_course ?? profile.current_course,
    institution_name: saved.institution_name ?? profile.institution_name,
    current_year: saved.current_year ?? profile.current_year,
    last_exam_percentage: saved.last_exam_percentage ?? profile.last_exam_percentage,
    is_hosteller: saved.is_hosteller ?? profile.is_hosteller,
    stream: saved.stream ?? profile.stream,
    board_university: saved.board_university ?? profile.board_university,
    passing_year: saved.passing_year ?? profile.passing_year,
    institution_type: saved.institution_type ?? profile.institution_type,
    parent_occupation: saved.parent_occupation ?? profile.parent_occupation,
    is_minority: saved.is_minority ?? profile.is_minority,
    is_farmer_family: saved.is_farmer_family ?? profile.is_farmer_family,
    is_orphan_single_parent: saved.is_orphan_single_parent ?? profile.is_orphan_single_parent,
    is_ex_serviceman_family: saved.is_ex_serviceman_family ?? profile.is_ex_serviceman_family,
    has_income_certificate: saved.has_income_certificate ?? profile.has_income_certificate,
    has_caste_certificate: saved.has_caste_certificate ?? profile.has_caste_certificate,
    has_domicile_certificate: saved.has_domicile_certificate ?? profile.has_domicile_certificate,
    is_aadhaar_bank_linked: saved.is_aadhaar_bank_linked ?? profile.is_aadhaar_bank_linked,
